...
Для тестов и замеров перфоманса, чтобы было все честно, нам нужно задеплоить наше приложение. Мне очень
...
Приложение представляет собой одну страницу из 10 секций (я их просто скопипастил, чтобы не выдумывать). Каждая секция
...
Чтобы понять, что происходит, давайте попробуем разобраться, что происходит.

...
(я их просто скопипастил, чтобы не выдумывать). Каждая секция
содержит запрос на бекенд, за 10 товарами и показываем 10 карточек с товарами. 
Так же на сервере есть запрос за
